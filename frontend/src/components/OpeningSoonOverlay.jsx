import { ShoppingBag, Clock3, Instagram, MapPin, Truck, ShieldCheck, Sparkles } from "lucide-react";

export default function OpeningSoonOverlay() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-6 py-20 relative z-10">
          ...
          <div className="text-center">
            ...
            <p className="max-w-2xl mx-auto mt-6 text-lg text-gray-600">
              We are preparing something amazing for Kakatpur and nearby areas.
      ...
      <section className="max-w-6xl mx-auto px-6 mt-10">
        ...
        <div className="bg-white rounded-3xl p-8 shadow-sm border">
          ...
          <p className="text-center mt-4 text-gray-600 text-lg">
            Kakatpur • Konark • Astaranga • Nearby Areas
          </p>

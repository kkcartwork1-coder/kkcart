            ...
            return (
              ...
              >
                ...
                >
                  ...
                  {/* Floating Micro ETA Tag */}
                  <div className="absolute bottom-2 left-2 bg-white/90 backdrop-blur-md text-emerald-700 text-[9px] font-black px-2 py-0.5 rounded-lg border border-emerald-500/10 flex items-center gap-0.5 tracking-wide">
                    <Timer size={10} className="stroke-[2.5]" />
                    <span>10 MINS</span>
                  </div>
                </div>

    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="p-4">
        ...
        <div className="bg-white rounded-3xl overflow-hidden border shadow-sm">
          <Item icon={<ShoppingBag size={20} />} text="My Orders" />
          <Item icon={<MapPin size={20} />} text="Saved Addresses" />
          <Item icon={<Heart size={20} />} text="Wishlist" />
          <Item icon={<Phone size={20} />} text="Contact Us" />
          <Item icon={<FileText size={20} />} text="Privacy Policy" />
          <Item icon={<FileText size={20} />} text="Terms & Conditions" />
        </div>
...
function Item({ icon, text }) {
  return (
    <button className="w-full flex items-center justify-between px-5 py-4 border-b last:border-none hover:bg-gray-50">
      <div className="flex items-center gap-4 text-gray-700">
        {icon}
        <span>{text}</span>
      </div>
